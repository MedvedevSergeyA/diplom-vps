        ...
        <div className="flex">
          ...
          {type === "password" && (
            <button
              ...
              className="p-2.5 text-sm font-medium text-white dark:bg-[#14458f] dark:border-[#14458f] bg-[#417b9c] border border-[#417b9c] rounded-r-[2px] hover:bg-[#265b8d] focus:ring-2 focus:outline-none focus:ring-[#265b8da9]"
            >
